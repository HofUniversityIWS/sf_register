...
class UserValidator extends GenericObjectValidator implements ValidatorInterface
{
    ...
    public function validate($object)
    {
        ...
        foreach ($propertyValidators as $propertyName => $validatorsNames) {
            if (!property_exists($object, $propertyName)) {
                ...
                $this->verifyProperty($propertyValue, (array) $validatorsNames, $messages->forProperty($propertyName));
            }
        }
     ...
     * @return void
     */
    protected function verifyProperty($value, $validatorNames, \TYPO3\CMS\Extbase\Error\Result $messages)
    {
